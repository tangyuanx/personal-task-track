# Design QA — ../demos/task-track.html v1.3.1 alignment

- Source visual truth: `./source-v1.3.1.png` captured from `../demos/task-track.html`.
- Implementation screenshot: `./implementation-final-desktop.png`.
- Full-view comparison: `./comparison-final.png`.
- Focused workflow comparison: `./focused-comparison-final.png`.
- Mobile evidence: `./implementation-final-mobile.png`.
- Phase 14 source evidence: `./phase14-source-knowledge.png`, `./phase14-source-flow.png`, `./phase14-source-sidebar.png`.
- Phase 14 implementation evidence: `./phase14-knowledge-final.png`, `./phase14-flow-collapsed-final.png`, `./phase14-mobile-flow-final.png`, `./phase14-mobile-knowledge-final.png`.
- Phase 14 combined comparison: `./phase14-comparison-final.png`.
...
- Phase 14 flow/sidebar fidelity: the collapsed sequence rail ends exactly at the last root-node center; helper copy/treatment matches `../demos/task-track.html`; the persistent dashed new-task card is absent and replaced by a low-emphasis hint while double-click/right-click creation remains available.
...
- Source visual truth: `./today-reference-card.png`, cropped from the user-approved dark-mode reference.
- Implementation screenshot: `./today-after-card.png`, captured from the actual project at `333×153` in dark mode with an empty Today list.
- Full-view and focused comparison: `./today-after-comparison.png`; the component itself is the focused region, so a separate detail crop was not needed.
...
- Implementation: `/Volumes/T7/work/personal-task-track/app/renderer/index.html`.
