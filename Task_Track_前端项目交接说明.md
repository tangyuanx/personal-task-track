...
### v0.1.46 候选 — 2026-07-12 — 已构建，待远程发布
...
- 桌面与 390×844 浏览器设计 QA 已通过；macOS ARM64 DMG/ZIP 与 Windows x64 NSIS 安装包构建成功，且发布目录不存在 `._*` 污染文件；尚待提交、标签和远程推送。
